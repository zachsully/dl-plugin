...
public class DLAltsImpl extends ASTWrapperPsiElement implements DLAlts {

  public DLAltsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DLVisitor visitor) {
    visitor.visitAlts(this);
  }
  ...
  @NotNull
  public DLAlt getAlt() {
    return findNotNullChildByClass(DLAlt.class);
  }
