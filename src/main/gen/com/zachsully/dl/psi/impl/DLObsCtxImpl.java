...
public class DLObsCtxImpl extends ASTWrapperPsiElement implements DLObsCtx {

  public DLObsCtxImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DLVisitor visitor) {
    visitor.visitObsCtx(this);
  }
  ...
  @Override
  @NotNull
  public DLObsCtx1 getObsCtx1() {
    return findNotNullChildByClass(DLObsCtx1.class);
  }
