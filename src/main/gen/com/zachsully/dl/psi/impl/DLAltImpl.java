...
public class DLAltImpl extends ASTWrapperPsiElement implements DLAlt {

  public DLAltImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DLPattern getPattern() {
    return findNotNullChildByClass(DLPattern.class);
  }
