...
public class DLCopatternImpl extends ASTWrapperPsiElement implements DLCopattern {

  public DLCopatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DLVisitor visitor) {
    visitor.visitCopattern(this);
  }
  ...
  @Override
  @NotNull
  public DLCopattern1 getCopattern1() {
    return findNotNullChildByClass(DLCopattern1.class);
  }
